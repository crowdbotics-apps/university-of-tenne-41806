...
## Project Structure
    ...
    ├── university_of_tenne_41806  # Django project configurations
...
1. Clone this repo and `cd university_of_tenne_41806`
...
2. Clone this repo and `cd university_of_tenne_41806`
